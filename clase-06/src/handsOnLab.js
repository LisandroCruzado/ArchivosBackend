...
app.get('/:iduser', (req,res) => {
    ...
    if(!user) {
        ...
        return res.send({error: 'User not found'}) //Se recomienda utilizar return con el res.send
     }
     console.log('No encontro el user'); //Manejar de eror una condicion que nos indica si esta bien o esta mal
